...
public class Room {
    ...
    /**
     * A function that converts time in milliseconds to time in seconds and hours.
     * @param time in milliseconds, which can be generated by the getBestTime function.
     * @return a string formated with several spaces, followed by the time in hours:minutes format
     */
    public String convertTimetoString(long time) {
        ...
        if (time <= 60000) {
            ...
            //converts the time into a human readable string, beginning with many spaces.
            long tempTime = time / 60000;
